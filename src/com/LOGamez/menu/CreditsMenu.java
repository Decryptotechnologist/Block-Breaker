    ...
    public void render(Render target, Graphics2D g) {
        ...
        if(CMTimer < 450 && CMTimer > 0){
            if(System.currentTimeMillis() % 47 == 0){
                ...
                target.scaleDraw(Texture.SI2015Logo, 1, BlockBreaker.getMainWidth()-40-(CMTimer/2), 288, 0, 0, 281, 271, 0x000000);
                target.scaleDraw(Texture.SI2015Logo, 1, BlockBreaker.getMainWidth()-38-(CMTimer/2), 286, 0, 0, 281, 271, 0xffffff);
        ...
        if(CMTimer == 0){
            ...
            if(count % 18 == 0){
                int x = BlockBreaker.getMainWidth()/2 - 168+count;
                double dx =  x * Math.sin(count/6);
                int y = BlockBreaker.getMainHeight()/2 - 108-count;
                ...
                animCredits.render(target, BlockBreaker.getMainWidth()/2 - 168-count, BlockBreaker.getMainHeight()/2 - 108-count, 1, 340, 180, creditsColor);
                animCredits.render(target, BlockBreaker.getMainWidth()/2 - 170-count, BlockBreaker.getMainHeight()/2 - 110-count, 1, 340, 180, 0xffffff);

                animCreditsA.render(target, BlockBreaker.getMainWidth()/2 - 168-count, BlockBreaker.getMainHeight()/2 - 108+count, 1, 340, 180, creditsColor);
                animCreditsA.render(target, BlockBreaker.getMainWidth()/2 - 170-count, BlockBreaker.getMainHeight()/2 - 110+count, 1, 340, 180, 0xffffff);

                animCreditsA.render(target, BlockBreaker.getMainWidth()/2 - 168+count, BlockBreaker.getMainHeight()/2 - 108+count, 1, 340, 180, creditsColor);
                animCreditsA.render(target, BlockBreaker.getMainWidth()/2 - 170+count, BlockBreaker.getMainHeight()/2 - 110+count, 1, 340, 180, 0xffffff);
            }
            
            animCreditsB.render(target, BlockBreaker.getMainWidth()/2 - 168, BlockBreaker.getMainHeight()/2 - 108, 1, 340, 180, creditsColor);
            animCreditsB.render(target, BlockBreaker.getMainWidth()/2 - 170, BlockBreaker.getMainHeight()/2 - 110, 1, 340, 180, 0xffffff);
        ...
        if(CMSkipTimer < 20){
            ...
            if(MouseInput.MouseX > 500 && MouseInput.MouseX < 500 + 80 && MouseInput.MouseY > 630 && MouseInput.MouseY < 630 + 30) {
                ...
                //Set Status Bar: Skip
                BlockBreaker.setStatusBar("Skip");
                ...
                if(MouseInput.MouseButton == 1) {
                    ...
                    BlockBreaker.setStatusBar("Ready");
                }
                ...
                BlockBreaker.setStatusBar("Credits Menu");
            }
        }
