...
public class LoseMenu extends Menu {
    ...
    private final int menuImageW = BlockBreaker.getMainWidth()+12;
    
    /**menuImageH variable of LoseMenu*/
    private final int menuImageH = BlockBreaker.getMainHeight();
    ...
    */
    ...
    public void render(Render target, Graphics2D g2d) {
        ...
        if (System.currentTimeMillis() / 450 % 2 == 0) {
            ...
            BlockBreaker.setStatusBar("Game Over!!!");
            ////////////////////////////////////////////////////////////////
        } else {
    ...
    */
    ...
    public void tick(Game game, boolean up, boolean down, boolean left, boolean right, boolean fire) {
        ...
        if (LMTimer == 0) {
            ...
            Game.level = new Level(1, BlockBreaker.getMainWidth(), BlockBreaker.getMainHeight());
