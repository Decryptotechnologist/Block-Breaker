...
import com.LOGamez.menu.CreditsMenu;
import com.LOGamez.menu.LoseMenu;
import com.LOGamez.menu.OptionsMenu;
...
public class Game extends Canvas implements Runnable {
    ...
    public static String TITLE = "Block Breaker Game";
    
    /**version variable of Game*/
    public static String version = "v0.3.5";
    ...
    public Game(int width, int height){
        ...
        img = new BufferedImage(BlockBreaker.getMainWidth(), BlockBreaker.getMainHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    */
    public void win() {
        ...
        BlockBreaker.setStatusBar("Time Bonus: "+timeBonus+" Accuracy Bonus: "+accuracyBonus+" Level Bonus: "+levelBonus);
        ...
        if(levelNo+1 < 21){//Game Levels Limit : Currently set to 8
            ...
            levelNo += 1;
            level = new Level(levelNo, BlockBreaker.getMainWidth(), BlockBreaker.getMainHeight());
            ...
            BlockBreaker.setStatusBar("Loading Level "+levelNo+" : "+Level.getLevelName());
        } else {
            BlockBreaker.setStatusBar("Game Complete!");
